# [Ansible role tftpd](#ansible-role-tftpd)

Install and configure tftpd on your system.

|GitHub|Issues|Pull Requests|Version|Downloads|
|------|------|-------------|-------|---------|
|[![github](https://github.com/buluma/ansible-role-tftpd/actions/workflows/molecule.yml/badge.svg)](https://github.com/buluma/ansible-role-tftpd/actions/workflows/molecule.yml)|[![Issues](https://img.shields.io/github/issues/buluma/ansible-role-tftpd.svg)](https://github.com/buluma/ansible-role-tftpd/issues/)|[![PullRequests](https://img.shields.io/github/issues-pr-closed-raw/buluma/ansible-role-tftpd.svg)](https://github.com/buluma/ansible-role-tftpd/pulls/)|[![Version](https://img.shields.io/github/release/buluma/ansible-role-tftpd.svg)](https://github.com/buluma/ansible-role-tftpd/releases/)|[![Ansible Role](https://img.shields.io/ansible/role/d/buluma/tftpd)](https://galaxy.ansible.com/ui/standalone/roles/buluma/tftpd/documentation)|
...
If you find issues, please register them on [GitHub](https://github.com/buluma/ansible-role-tftpd/issues).
...
### Get Help
- Report issues: https://github.com/buluma/ansible-role-tftpd/issues/new
- See docs: https://docs.ansible.com/collection/gallery/ansible-role-tftpd
